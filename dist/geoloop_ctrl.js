  ...
  return {
    ...
    execute: function () {
      ...
      panelDefaults = {
        ...
        thredds: {
          url: 'https://iws.ismar.cnr.it/thredds/wms/tmes_sea_level_frmc/TMES_sea_level_collection_best.ncd', // one of: url, text
      ...
      GeoLoopCtrl = function (_MetricsPanelCtrl) {
        ...
        function GeoLoopCtrl($scope, $injector) {
          ...
          _.defaults(_this.panel, panelDefaults.thredds);
